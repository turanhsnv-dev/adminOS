...
export const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex font-sans selection:bg-primary/20 relative isolate">
      ...
      {/* --- ARXA PLAN EFFEKTLƏRİ (NOQTƏSİZ) --- */}
      
      {/* 1. Base Gradient: Yuxarıdan aşağıya zəif rəng keçidi (Login havası üçün) */}
      <div className="fixed inset-0 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 pointer-events-none -z-50"></div>

      {/* 2. Spotlight Effekti: Mərkəzdə zəif işıq (Dərinlik üçün vacibdir) */}
      ...
      {/* QEYD: Nöqtələr (Dot Pattern) hissəsi tamamilə silindi */}
      ...
      >
        ...
        {/* Məzmun sahəsi */}
        <main className="flex-1 px-6 pb-6 relative z-10">
             <Outlet />
        </main>
