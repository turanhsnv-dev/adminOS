...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background text-foreground relative overflow-hidden selection:bg-neon/30">
      ...
      <div className="w-full max-w-[420px] px-4 relative z-10">
        <div className={cn(
            "backdrop-blur-xl shadow-2xl rounded-2xl p-8 md:p-10",
